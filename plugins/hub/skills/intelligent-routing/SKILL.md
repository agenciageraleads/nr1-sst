...
### With PROTOCOL.md Rules

- **Priority**: PROTOCOL.md rules > intelligent-routing
- If PROTOCOL.md (or the host project's `CLAUDE.md`) specifies explicit routing, follow it
...
Add to `PROTOCOL.md` (or your project's `CLAUDE.md`) temporarily:
...
**Next Steps**: This skill is wired into `PROTOCOL.md` TIER 0 rules by default.
